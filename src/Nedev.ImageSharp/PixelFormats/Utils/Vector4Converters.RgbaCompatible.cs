...
namespace Nedev.ImageSharp.PixelFormats.Utils
{
    /// <content>
    ...
    internal static partial class Vector4Converters
    {
        ...
        public static class RgbaCompatible
        {
            ...
            /// <summary>
            /// Provides an efficient default implementation for <see cref="PixelOperations{TPixel}.ToVector4(Nedev.ImageSharp.Configuration,System.ReadOnlySpan{TPixel},System.Span{System.Numerics.Vector4},Nedev.ImageSharp.PixelFormats.PixelConversionModifiers)"/>
            ...
            /// <summary>
            /// Provides an efficient default implementation for <see cref="PixelOperations{TPixel}.FromVector4Destructive(Nedev.ImageSharp.Configuration,System.Span{System.Numerics.Vector4},System.Span{TPixel},Nedev.ImageSharp.PixelFormats.PixelConversionModifiers)"/>
            /// The method is works by internally converting to a <see cref="Rgba32"/> therefore it's not applicable for that type!
            /// </summary>
            [MethodImpl(InliningOptions.ShortMethod)]
