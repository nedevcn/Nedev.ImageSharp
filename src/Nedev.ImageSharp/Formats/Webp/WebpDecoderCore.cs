...
using Nedev.ImageSharp.Formats.Webp.BitReader;
using Nedev.ImageSharp.Formats.Webp.Lossless;
using Nedev.ImageSharp.Formats.Webp.Lossy;
using Nedev.ImageSharp.IO;
using Nedev.ImageSharp.Memory;
using Nedev.ImageSharp.Metadata;
using Nedev.ImageSharp.Metadata.Profiles.Exif;
using Nedev.ImageSharp.Metadata.Profiles.Icc;
using Nedev.ImageSharp.Metadata.Profiles.Xmp;
...
namespace Nedev.ImageSharp.Formats.Webp
{
    ...
    internal sealed class WebpDecoderCore : IImageDecoderInternals
    {
        ...
        private uint ReadImageHeader()
        {
            ...
            // The file size in the header is the total size of the chunks that follow plus 4 bytes for the â€˜WEBPâ€?FourCC.
