...
using Nedev.ImageSharp.Compression.Zlib;
using Nedev.ImageSharp.Formats.Tiff.Compression;
using Nedev.ImageSharp.Formats.Tiff.Constants;
using Nedev.ImageSharp.Formats.Tiff.Writers;
...
namespace Nedev.ImageSharp.Formats.Tiff
{
    /// <summary>
            ...
            if (bitsPerPixel.HasValue)
            {
                switch (bitsPerPixel)
                {
                    case TiffBitsPerPixel.Bit1:
                        ...
                        {
                            // The â€œnormalâ€?PhotometricInterpretation for bilevel CCITT compressed data is WhiteIsZero.
